...
import Apis from "@/pages/api/mahasiswa";
...
const GetMahasiswa = ({mahasiswa}) => {
    ...
    const handleDelete = async (nim) => {
        try {
            ...
            router.push('/admin/data-mahasiswa');
        } catch (error) {
            console.error(error);
        }
    }    
    ...
    return (
        ...
        <div className="flex felx-row justify-between">
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    onClick={() => {router.push(`/admin/data-mahasiswa?nim=${nim}`)}}>Search</button>
                </div>
            </div>
        </div>
                    ...
                    dark:hover:bg-gray-500 dark:text-white">
                        ...
                        <td className="px-6 py-4 font-sm whitespace-nowrap">
                            <div className="flex flex-row justify-start">
                                ...
                                <button
                                className="text-white text-md bg-red-700 py-1 px-2 cursor-pointer hover:bg-red-900 ml-4"
        ...
        <button
            className="text-white text-md bg-red-700 py-1 px-2 cursor-pointer hover:bg-red-900 ml-4"
            onClick={() => {router.push(`/admin/createmahasiswa`)}}>TAMBAH DATA</button>
